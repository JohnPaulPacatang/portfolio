...
interface ListViewProps {
  ...
  handleMouseMove: (e: React.MouseEvent<HTMLDivElement, MouseEvent>, index: number) => void;
  handleMouseEnter: (index: number) => void;
  handleMouseLeave: () => void;
  handleViewClick: (link: string) => void;
}

const ProjectsListView: React.FC<ListViewProps> = ({
  projects,
  hoveredProject,
  displayPosition,
  handleMouseMove,
      ...
      {projects.map((project, index) => (
        ...
        >
          ...
          {hoveredProject === index && (
            ...
            >
              <div className="bg-black/80 overflow-hidden" style={{ width: "450px", height: "350px" }}>
